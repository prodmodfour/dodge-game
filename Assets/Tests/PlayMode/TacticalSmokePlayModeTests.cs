...
namespace ReactionTactics.Tests.PlayMode
{
    public sealed class TacticalSmokePlayModeTests
    {
        ...
        public IEnumerator MainPrototypeStartsWithCoreSystemsAndLivingTeams()
        {
            ...
            {
                registry = UnityEngine.Object.FindAnyObjectByType<UnitRegistry>();
            ...
            var combatManager = UnityEngine.Object.FindAnyObjectByType<CombatManager>();
            var scenarioLoader = UnityEngine.Object.FindAnyObjectByType<ScenarioLoader>();
            var combatHud = UnityEngine.Object.FindAnyObjectByType<CombatHud>();
