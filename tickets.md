# `tickets.md` — Reaction Tactics Prototype
...
## T001 — Initialize or verify the Unity project
...
## T002 — Add project-level coding-agent instructions
...
## T003 — Create the prototype folder layout
...
## T004 — Add runtime, editor, and test assembly definitions
...
## T005 — Create and register the main prototype scene
...
## T006 — Add a minimal custom hierarchy CLI tool
...
## T007 — Add a minimal asset finder CLI tool
...
## T008 — Add a prototype design README
...
## T009 — Add a Linux build script shell
...
## T010 — Add the first empty EditMode smoke test
...
## T012 — Add grid distance helpers
...
## T013 — Add `CardinalDirection` and direction math
...
## T014 — Add teams and unit identity model
...
## T015 — Add lightweight result/error types
...
## T018 — Add in-memory grid map implementation
...
## T019 — Add grid/world conversion metrics
...
## T021 — Add serialized prototype map definition
...
## T022 — Add editor menu to create the default prototype map
...
## T023 — Add `GridManager` scene component
...
## T024 — Add primitive tile view component
...
## T026 — Add prototype terrain materials
...
## T027 — Add terrain CLI scene setup tool
...
## T028 — Add grid neighbor service
...
## T029 — Add movement cost service
...
## T030 — Add grid blocker and line-of-sight flags to visuals
...
## T032 — Add pathfinding node and path result types
...
## T033 — Implement reachable-cell search
...
## T034 — Implement shortest path reconstruction
...
## T035 — Add occupancy query interface
...
## T036 — Make pathfinding occupancy-aware
...
## T037 — Add movement command model
...
## T038 — Add movement range preview data
...
## T039 — Add movement path animation component
...
## T040 — Add movement pathfinding tests
...
## T041 — Add unit stats ScriptableObject
...
## T042 — Add unit runtime component
...
## T044 — Add health and damage behavior
...
## T046 — Add prototype unit prefab
...
## T048 — Add editor CLI tool to create unit stat assets
...
## T049 — Add unit scene setup CLI tool
...
## T052 — Add grid mouse picking service
...
## T054 — Add selection state model
...
## T058 — Add input scene setup tool
...
## T059 — Add combat phase enum and state object
...
## T061 — Add initiative and active-turn order
...
## T062 — Add round start AP refresh
...
## T065 — Enforce actions only on active unit's turn
...
## T066 — Add active unit visual highlight
...
## T068 — Add ability timing and shape enums
...
## T069 — Add ability definition ScriptableObject
...
## T072 — Add ability target validator interface
...
## T073 — Add action declaration service
...
## T074 — Add ability catalog component
...
## T075 — Add editor CLI tool to create default ability assets
...
## T076 — Assign default abilities to units
...
## T078 — Add action resolver shell
...
## T079 — Wire action declaration into combat manager
...
## T080 — Add ability/action system tests
...
## T081 — Implement melee targeting validation
...
## T082 — Implement Option A melee resolution
...
## T083 — Add melee attack presentation placeholder
...
## T084 — Implement radius AoE shape service
...
## T085 — Implement AoE targeting validation
...
## T086 — Implement AoE resolution after reactions
...
## T087 — Implement cardinal cone shape service
...
## T088 — Implement cone targeting validation
...
## T089 — Implement cone resolution after reactions
...
## T090 — Add simple line-of-sight service
...
## T091 — Integrate line of sight into ranged validation
...
## T092 — Add deterministic damage event data
...
## T093 — Add attack shape integration tests
...
## T094 — Add reaction window model
...
## T095 — Implement reaction distance ordering
...
## T096 — Add reaction eligibility validation
...
## T097 — Wire reaction window before action resolution
...
## T098 — Add pass reaction command
...
## T099 — Add reaction movement command
...
## T100 — Add active movement command
...
## T101 — Add safe cell analyzer for pending intent
...
## T103 — Integrate brace into resolver
...
## T104 — Prevent nested full reaction windows
...
## T105 — Add reaction UI state integration
...
## T106 — Auto-pass reactors with no meaningful reaction
...
## T107 — Add reaction system tests
...
## T109 — Add unit HP/AP nameplates
...
## T112 — Add tile highlight manager
...
## T113 — Show active movement range
...
## T114 — Show action danger previews
...
## T115 — Show reaction movement safety
...
## T116 — Add target confirmation and cancel flow
...
## T119 — Add rules tooltip/help overlay
...
## T121 — Implement AI target selection
...
## T122 — Implement AI active movement toward target
...
## T123 — Implement AI melee action
...
## T126 — Implement AI reaction movement
...
## T127 — Implement AI brace reaction
...
## T130 — Add scenario definition ScriptableObject
...
## T131 — Add default scenario asset creator
...
## T132 — Add scenario loader component
...
## T133 — Replace manual unit setup with scenario setup
...
## T134 — Add all-in-one prototype scene setup tool
...
## T135 — Tune default AP, HP, and damage values
...
## T136 — Add prototype visuals polish pass
...
## T137 — Add scene content tests or validation CLI tool
...
## T138 — Wire active movement to UI and command router
...
## T139 — Wire melee action to UI and command router
...
## T140 — Wire cone action to UI and command router
...
## T141 — Wire AoE action to UI and command router
...
## T142 — Wire brace reaction to UI and command router
...
## T143 — Complete player-vs-AI turn handoff
...
## T144 — Add PlayMode tactical smoke test
...
## T145 — Add deterministic combat simulation test
...
## T146 — Add full-scene validation CLI smoke tool
...
## T147 — Run full EditMode suite and fix failures
...
## T148 — Run full PlayMode suite and fix failures
...
## T149 — Capture prototype screenshots for review
...
## T150 — Profile the prototype scene briefly
...
## T151 — Build Linux prototype player
...
## T152 — Add prototype playtest checklist
...
## T153 — Add known limitations document
...
## T154 — Final prototype cleanup pass
...
## T155 — Tag prototype-complete checklist commit
